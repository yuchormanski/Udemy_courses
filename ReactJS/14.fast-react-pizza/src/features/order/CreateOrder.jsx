    ...
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              className="md:py-3duration-300 w-full
              rounded-full border border-stone-200
              px-4 py-2 text-sm transition-all placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-yellow-400 md:px-6 md:py-3"
              type="text"
              name="address"
              required
            />
